      ...
      content: {
        "pt-br": {
          ...
          all: {
            ...
            enable: false,
            alert:
              "Ao desabilitar os cookies, alguns serviços podem não funcionar corretamente.",
          },
          categories: [
            {
              id: "c1",
            ...
            },
            {
              ...
              name: "Desempenho",
              alert:
                "Ao desligar, não irá funcionar o Google Analytics, ou seja, as estatísticas de acesso ao portal.",
              description:
          ...
          cookies: [
            ...
            },
            {
              ...
              purpose: "Funcional",
              description:
                "O cookie é utilizado no portal do Serpro para redirecionar o usuário para a pasta de idioma correto.",
              alert:
                "Se você não permitir esses cookies, esses serviços podem não funcionar corretamente.",
            },
            {
              id: "k6",
              categoryId: "c2",
            ...
            },
            {
              ...
              purpose: "Estatística",
              description:
                "Usado para limitar solicitações ao Google Analytics",
            },
          ],
          notes: [
            {
        ...
        en: {
          ...
          intro: {
            observation:
              'We use cookies to store information about how you use our site and the pages you visit. All to make your experience as pleasant as possible. To understand the types of cookies we use and customize them, click on "Set Cookies". By clicking "Accept", you consent to the use of cookies.',
            title: "We respect your privacy",
            update: "12/28/2021",
            foreword:
              "Serpro values your privacy and guarantees the protection of your personal data! Please note that we use cookies to enhance your site experience, according to our Privacy Policy. Feel free to customize the cookies that are not strictly necessary.",
          },
          all: {
            alert:
              "If you not enable some cookies, some services may not function properly.",
          },
          categories: [
            {
              id: "c1",
              ...
              optIn: true,
              description:
                "These cookies are indispensable for the functioning of the site and cannot be turned off on our systems because they use essential features. They are usually only set in response to actions you take that are equivalent to a service request, such as setting your privacy preferences, logging in, or filling out forms. You can set your browser to block or alert you about these cookies, but some parts of the site will not work. These cookies do not store any personally identifiable information.",
            },
            {
              id: "c2",
              name: "Functional",
              alert:
                "If you do not enable these cookies, these services may not function properly.",
              description:
                "These cookies enable the site to provide you with enhanced functionality and customization. They can be defined by us or by third-party providers of services that we add to our pages. If you do not enable these cookies, some or all of these services may not function properly.",
            },
            {
              id: "c3",
              name: "Performance",
              alert:
                "When you turn it off, Google Analytics will not work, i.e. the statistics of access to the portal.",
              description:
          ...
          cookies: [
            ...
            },
            {
              ...
              purpose: "Functional",
              description:
                "Cookie of Plone messages during content management.",
            },
            {
              id: "5",
              categoryId: "c2",
              ...
              purpose: "Functional",
              description:
                "The cookie is used on the Serpro portal to redirect the user to the correct language folder.",
            },
            {
              id: "k6",
              categoryId: "c2",
              ...
              purpose: "Functional",
              description:
                "The reCAPTCHA Enterprise sets a required cookie (_GRECAPTCHA) when executed for the purpose of providing your risk analysis.",
            },
            {
              id: "k7",
              categoryId: "c3",
              ...
              purpose: "Statistics",
              description:
                'Used to distinguish users by Google Analytics (third-party analytics cookies: google analytics for analytical purposes). Type of processed data: IP address. To maximize the privacy of our visitors, we use an "IP masking" feature that forces the system to black out the last 8 digits of the visitor"s IP address before any processing is done. Objective analyzed: collect information, in aggregate form, about the number of users and the way they visit our site, for statistical purposes.',
            },
            {
              id: "k8",
              categoryId: "c3",
          ...
          notes: [
            ...
            },
            {
              ...
              answer:
                "Cookies are used by websites primarily to identify and store information in the browser about visitors. They also serve to customize the page according to the profile, record statistical and monitoring data, or improve the performance of the application by facilitating the transport of data between pages of the same site.",
            },
          ],
          links: [
            {
